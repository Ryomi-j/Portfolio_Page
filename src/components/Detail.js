  ...
  const contents = [
    {
      ...
      img: <img src="img/detail-imgs/challanges.jpg" alt="challanges" />,
      description: `
    ...
    },
    {
      id: 2,
      title: "Travel",
      img: <img src="img/detail-imgs/travel.jpg" alt="travel" />,
      description: `
    ...
    },
    {
      id: 3,
      title: "Web Food",
      img: <img src="img/detail-imgs/web-food.jpg" alt="web_food" />,
      description: `
    ...
    },
    {
      id: 4,
      title: "Tic, Tac, Toe",
      img: <img src="img/detail-imgs/tic tac toe.jpg" alt="tic tac to" />,
      description: `
    ...
    },
    {
      id: 5,
      title: "Calculator",
      img: <img src="img/detail-imgs/calculator.jpg" />,
      description: `
    ...
    },
    {
      id: 6,
      title: "Movie App",
      img: <img src="img/detail-imgs/movie.jpg" alt="movie" />,
      description: `
    ...
    },
    {
      id: 7,
      title: "Portfolio",
      img: <img src="img/detail-imgs/portfolio.jpg" alt="portfolio" />,
      description: `
